...
if InventoryTetrisPersistence.serverPatched then
    return
end
InventoryTetrisPersistence.serverPatched = true
...
local function onClientCommand(module, command, player, args)
    ...
    local isFurnitureGridCommand = module == "InventoryTetris" and command == "syncIsoObjectGrid"
...
print("[InventoryTetrisPersistence] Server persistence hooks installed.")
